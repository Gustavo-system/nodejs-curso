...
getEmpleado(idx)
    .then( (empleado) => {
        getSalario(idx)
            .then( (salario) => {
                console.log(`Promesa Hell --> El salario del empleado ${empleado} es de: ${salario}`)
            })
...
getEmpleado(idx)
    ...
    .then((salario) => {
        return console.log(`Promesa en Cadena --> El salario del empleado ${nombre} es de: ${salario}`);
    })
